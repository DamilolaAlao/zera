...
export default class ElectronicsItemForm extends React.Component{
    state={
        condition:'new',
        name_focus:false,
        selectedQuantity:1,
    ...
    render(){
        ...
        const category = this.props.navigation.getParam('subCategory');
        ...
        return(
            <View style={styles.container}>
                ...
                <RobotoText style={styles.topText}>
                    {category.title==='Others'?'Item Details':category.title}
                </RobotoText>
                ...
                {category.title==="Others"?
                    <View>
                        ...
                        <TextInput
                            ...
                            placeholderTextColor='Lawn mower'
                    ...
                    <View>
                        <RobotoText  style={[styles.quqantityText,{
                            color:'black'
                        }]} >Othe Details</RobotoText>
                        <TextInput
                            multiline
                            numberOfLines={6}
                            style={!this.state.details_focus?styles.formInput:styles.formInputfocused}
