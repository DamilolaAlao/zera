...
export default class ElectronicsSubCategory extends React.Component{
                ...
                <ScrollView contentContainerStyle={{paddingBottom:hp(60)}}>
                    {
                        ...
                        return(
                            <TouchableOpacity
                            key={index}
                            onPress={()=>this.props.navigation.navigate('ElectronicsItemForm',{category:category,subCategory:item})}  
