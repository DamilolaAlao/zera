...
export default class GivebookForm extends React.Component{
    state={
        condition:'new',
            ...
            <KeyboardAvoidingView behavior='position' >
                ...
                <View style={[styles.status,{flexDirection:'column'}]}>
                    ...
                    <View>
                        ...
                        <View style={!this.state.quantity_focus ?styles.formInput:styles.formInputfocused}
                        >
