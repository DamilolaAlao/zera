...
export default class FashionOptions extends React.Component{
    ...
    render(){
      ...
      return(
            <View style={styles.container}>
                ...
                />
                {/* end of Header */}
      <RobotoText style={styles.topText}>{options.title}</RobotoText>
                ...
                <View style={styles.optionView}>
                    ...
                    {
                        options.subcategories.map((item,index)=>{
                        return(
                            <TouchableOpacity
                                onPress={()=>this.props.navigation.navigate('GiveFashionform')}
                            key={index}
